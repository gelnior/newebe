...
(function() {
  var ConfirmationDialog, DocumentSelector, FormDialog, InfoDialog, LoadingIndicator, LoginView, PlatformController, PlatformView, RegisterPasswordView, RegisterView, Row, TagCombo, convertUrlsToMarkdownLink, infoDialog, loadingIndicator, loginView, platformController, platformView, registerPasswordView, registerView,
  ...
  PlatformController = (function(_super) {
    ...
    function PlatformController() {
      return PlatformController.__super__.constructor.apply(this, arguments);
    }
  ...
  PlatformView = (function(_super) {
    ...
    PlatformView.prototype.onCommonsClicked = function(ev) {
      if (ev) {
        ev.preventDefault();
      }
      this.switchTo("#commons", '/commons/content/', "Commons");
      return false;
    };
